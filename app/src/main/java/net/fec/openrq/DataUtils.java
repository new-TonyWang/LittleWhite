...
final class DataUtils {
    ...
    static interface SourceSymbolSupplier<SS> {//MLGB缁佺偞鎼锋担婊愮礉閼板啳妾绘潻鍥у従娴犳牔姹夌拠璁崇稑娴狅絿鐖滈惃鍕妳閸欐ぞ绨℃稊锟�
    ...
    static <SB> ImmutableList<SB> partitionSourceData(
        ...
        final int Kt = fecParams.totalSymbols();//缁楋箑褰块幀缁樻殶
        final int Z = fecParams.numberOfSourceBlocks();//閸ф娈戞稉顏呮殶
