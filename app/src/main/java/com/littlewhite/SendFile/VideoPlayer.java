...
public class VideoPlayer extends AppCompatActivity  implements View.OnClickListener{
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaverTOJPG(reader.acquireNextImage()));
        }
    };
...
//            Log.d("peng", "1010101010101010101");
            switch (mState) {
                case STATE_PREVIEW: {
                    Log.d("peng", "6666666666666666666667");
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    if (afState == 0) {
                        ...
                        if (aeState == 0 ||
                            ...
                            mState = STATE_PICTURE_TAKEN;
                            Log.d("peng", "2222222222222222");
                            captureStillPicture();

                        } else {
                            runPrecaptureSequence();
                        }
                        Log.d("peng", "7777777777777777778");
                    }
                    break;
                }
        ...
        public void onCaptureProgressed(@NonNull CameraCaptureSession session,
            ...
            Log.d("peng", "9999999999999999991");
...
//            Log.d("peng", "88888888888888889");
    ...
    private void setUpCameraOutputs(int width, int height, int outputWid, int outputHei) {
        ...
        try {
                ...
                mImageReader = ImageReader.newInstance(outputWid, outputHei, ImageFormat.JPEG, 30);
