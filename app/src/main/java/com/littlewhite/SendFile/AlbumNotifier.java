...
public class AlbumNotifier {
    ...
    public static final String TAG = AlbumNotifier.class.getSimpleName();



    public  void notifyScanDcim(Context context, String filePath) {
        scanFile(context, filePath);
    }

    public  void insertVideoToMediaStore(Context context, String filePath, long dateTaken, long duration) {
        insertVideoToMediaStore(context, filePath, dateTaken, 0, 0, duration);
    }



    public  void insertImageToMediaStore(Context context, String filePath, long createTime) {
     ...
     * @param height     高度
     */
    public  void insertImageToMediaStore(Context context, String filePath, long createTime, int width, int height) {
