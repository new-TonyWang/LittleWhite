...
public final class Result {
	 ...
	 * @param mode
	 */
	public Result(String text, byte[] rawBytes, ResultPoint[] resultPoints, BarcodeFormat format,Mode mode) {
		this(text, rawBytes, resultPoints, format, System.currentTimeMillis());
		this.mode = mode;
	}
	/**
	 ...
	 * @param format
	 */
	public Result( byte[] rawBytes, ResultPoint[] resultPoints, BarcodeFormat format,Mode mode) {
		this(null, rawBytes, resultPoints, format, System.currentTimeMillis());
		this.mode = mode;
	}
