...
public final class DecoderResult {
	 ...
	 * @param saParity
	 */
	public DecoderResult(byte[] rawBytes, List<byte[]> byteSegments, String ecLevel, int saSequence,
			int saParity,Mode mode) {
		this.rawBytes = rawBytes;
		this.numBits = rawBytes == null ? 0 : 8 * rawBytes.length;
		this.text = null;
	...
	/**
	 * @param numBits overrides the number of bits that are valid in
	 *                {@link #getRawBytes()}
	 * @since 3.3.0
	 */
	...
	/**
	 * @return list of byte segments in the result, or {@code null} if not
	 *         applicable
	 */
	...
	/**
	 * @return name of error correction level used, or {@code null} if not
	 *         applicable
	 */
